/* animtab.c - Animation tables for MicropolisNT
...
short smokeOffsetX[4] = {  1,  2,  1,  2 };
short smokeOffsetY[4] = { -1, -1,  0,  0 };

/* Industrial smoke position data */
short indOffsetX[8] = { -1,  0,  1,  0,  0,  0,  0,  1 };
short indOffsetY[8] = { -1,  0, -1, -1,  0,  0, -1, -1 };

/* Industrial building types that can have smoke */
short indSmokeTable[8] = { 621, 0, 641, 649, 0, 0, 676, 686 };